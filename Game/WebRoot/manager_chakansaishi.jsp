...
<html>
  <head>
    ...
    <title>My JSP 'manager_chakansaishi.jsp' starting page</title>
...
-->
  ...
  <body><script type="text/javascript">
	...
	function showTable(obj){
		//alert(obj);
		sendRequest("select_saishi.jsp?sort=" + obj+"&num="+Math.random(),"select_categoryyy.jsp?sort="+obj+"&num="+Math.random());
	}
 //发送请求函数
...
<script type="text/javascript">
	...
	function showTable2(obj){
		//alert(obj);
		sendRequest_("select_saishix.jsp?sort=" + obj+"&num="+Math.random());
	}
 //发送请求函数
...
<script type="text/javascript">
	...
	{
		//alert(obj);
		sendRequest_1("select_updatex.jsp?sort=" + obj+"&num="+Math.random());
	}
 //发送请求函数
...
//}
	...
	{
		//alert(obj);
		sendRequest_2("select_deletex.jsp?sort=" + obj+"&num="+Math.random());
	}
 //发送请求函数
    ...
    <tr>
      <th scope="col"><table width="800" border="1" cellspacing="0" bordercolor="#999999">
        ...
        <tr>
          ...
          <form method="post" action="ChakansaishiServlet">
          <table width="600">
	          	<tr>
	          	<br/><br/><td width="300">
	          	<div align="right">
		          ...
		          <input type="button" name="返回" value="返回" onclick="window.location.href='manager_chakansaishi.jsp'">
		          ...
		          <div id="plistDiv" align="center" style="height:480px;overflow-y:auto;">			
					...
					<table border="5"  class="studenttable" bgcolor="#fffff">
