...
<html>
  <head>
    ...
    <title>My JSP 'select_category.jsp' starting page</title>
  ...
  %>
	...
	ProjectServlet projectservlet = new ProjectServlet();
  	//System.out.println("categoryy---"+sex+"*****");
  	//System.out.println("categoryy---"+flag_sex+"哇哇");
  	ResultSet rs = projectservlet.getCategoryBySex(sex);
  	//System.out.println("categoryy---"+sex+"*****getCategoryBySex完成！");
  	while(rs.next()){
  		String ab=null;
