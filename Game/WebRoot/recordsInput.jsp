...
function getCheckinTable(){
	...
	if(pid){
		...
		sendRequest("recordsInputTable.jsp?pid=" + pid+"&cid="+cid+"&num="+Math.random());
		}
	else
		alert("项目编号不能为空。");
}
        ...
        <tr>
          ...
          <form method="post" action="RecordsServlet">
	          <table width="600">
	          	...
	          	<td width="50" align="left"><input id="save" type="submit" value="保存" disabled/></td>
		        </tr>         		          
		        <tr><td colspan="4">
		        <div id="recordsDiv" align="center" style="height:450px;overflow-y:auto;">			
				<br>	
