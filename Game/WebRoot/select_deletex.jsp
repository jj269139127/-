...
<html>
  <head>
    ...
    <title>My JSP 'select_deletex.jsp' starting page</title>
  ...
  <body>
    ...
    <%
  	...
  	//System.out.println("delete_name1---"+id+"*****");
  	projectservlet.getDeleteSaishiByName(id);
  	//System.out.println("delete_name2---"+id+"*****getDeleteSaishiByName！");
  	%>
  </body>
</html>
