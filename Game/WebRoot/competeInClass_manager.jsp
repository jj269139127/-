...
<script type="text/javascript">
	...
	function showComprterTable(obj){
		//alert(obj);
		sendRequest("competerTable_manager.jsp?sort=" + obj+"&num="+Math.random(),"departmentselect.jsp?sort="+obj+"&num="+Math.random());
	}
 //发送请求函数
...
// 处理返回信息函数
   	function processResponse1() {
        if (XMLHttpReq1.readyState == 4) { // 判断对象状态
            if (XMLHttpReq1.status == 200) { // 信息已经成功返回，开始处理信息
    			...
    			document.getElementById("slistDiv").innerHTML=result;
            } else { //页面不正常
 ...
 <script type="text/javascript">
function getCompeterInformation(cid)
{
	window.showModalDialog("competer_project.jsp?cid="+cid);
}
</script>
<script type="text/javascript">
	var XMLHttpReq;
	...
	function showDepartmentCompeter(obj){
		sendRequest_("competerTable_manager.jsp?sort=" + obj+"&num="+Math.random());
	}
 //发送请求函数
        ...
        <tr>
          ...
          <th valign="top" bgcolor="#E3E3E3">
	          <table width="600">
	          	...
	          	<div align="right">
	          	学院：
		          <select name="recordInClass" onchange="showComprterTable(this.options[this.options.selectedIndex].value)">
		          ...
		          <tr><td colspan="2">
		          <br>
		          <div id="slistDiv" align="center" style="height:480px;overflow-y:auto;">			
