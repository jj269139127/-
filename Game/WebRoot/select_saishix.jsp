...
<html>
  <head>
    ...
    <title>My JSP 'select_saishix.jsp' starting page</title>
  ...
  <body>
    ...
    <tr align="center"><td>项目编号</td><td>性别</td><td>类型</td><td>名称</td><td>最大人数</td><td>修改</td><td>删除</td></tr>
  	...
  	//System.out.println("saishix---"+sex+"123456sex*****");
  	ResultSet rs = projectservlet.getSaishiBySexX(sex);
  	//System.out.println("saishix---"+sex+"*****getSaishiBySex！");
  	while(rs.next()){
		String ab=null;
		String cd=null;
